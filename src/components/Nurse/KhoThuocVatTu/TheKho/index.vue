<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white border border-gray-200/60 rounded-[10px] shadow-lg w-[510px] relative">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="border border-gray-200/60 rounded-[10px] overflow-hidden">
            <div
              ...
              :class="{ 'border-b border-gray-200/60': index < history.length - 1 }"
            >
              <!-- Left: Type & Info -->
              <div class="flex flex-col gap-0">
              ...
              <div class="font-nunito text-base leading-6 tracking-tight" :class="item.change > 0 ? 'text-[#00a63e]' : 'text-[#e7000b]'">
      ...
      <!-- Footer -->
      <div class="flex items-center justify-end px-6 py-4 border-t border-gray-200/60">
        <button
          @click="$emit('close')"
...
const iconClose = "https://www.figma.com/api/mcp/asset/ae11f3c4-9d85-41f5-865c-78ae8996bfe6"
