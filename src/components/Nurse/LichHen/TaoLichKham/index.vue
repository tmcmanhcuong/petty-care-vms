<template>
  ...
  >
    <div class="bg-white rounded-[10px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] w-full max-w-md flex flex-col gap-4 pt-6 px-6 pb-0 overflow-hidden">
      <!-- Dialog Header -->
      ...
      <div class="flex flex-col gap-6 h-[360px]">
        ...
        <div class="bg-teal-50 border-2 border-[#96f7e4] rounded-[10px] pt-[18px] px-[18px] pb-0.5 flex flex-col gap-4">
          ...
          <div class="bg-[#f9fafb] border border-black/15 rounded-lg px-3 py-1 h-12 flex items-center">
            <input
              ref="searchInput"
              v-model="searchQuery"
              type="text"
              placeholder="Nhập SĐT hoặc Tên (Auto-focus)..."
              class="w-full bg-transparent font-nunito text-sm text-[#717182] tracking-[-0.1504px] outline-none placeholder:text-[#717182]"
              @input="handleSearch"
            />
          </div>
        </div>
        ...
        <div class="bg-blue-50 border-2 border-[#bedbff] rounded-[10px] pt-[18px] px-[18px] pb-0.5 flex flex-col gap-4">
          <div class="flex items-center gap-2 h-6">
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-0.5">
              ...
              <button
                class="bg-[#f9fafb] border border-black/15 rounded-lg px-[13px] py-px h-9 flex items-center justify-between hover:border-[#009689] transition-colors"
            ...
            <div class="flex flex-col gap-0.5">
              <div class="flex items-baseline gap-px">
                ...
                <span class="font-nunito font-medium text-sm leading-[14px] text-[#fb2c36] tracking-[-0.1504px]">
                  *
                </span>
              </div>
              <button
      ...
      <!-- Dialog Footer -->
      <div class="flex items-center justify-end gap-2 h-9 pb-6">
        <button
        ...
        <button
          class="bg-[#009689] rounded-lg px-3 py-2 flex items-center gap-3 hover:bg-[#007d72] transition-colors"
          @click="handleSubmit"
        >
...
// Icons
const iconUser = "https://www.figma.com/api/mcp/asset/73ac094a-c79d-4bd4-affd-5380b088b2af"
const iconService = "https://www.figma.com/api/mcp/asset/57520e3f-9f22-4c25-8a31-3be4371178cd"
const iconChevronDown = "https://www.figma.com/api/mcp/asset/182e137a-e0da-4077-8d26-98371db706d5"
const iconInfo = "https://www.figma.com/api/mcp/asset/cf2d49ea-3232-44e3-9cab-858396917d5a"
const iconCheck = "https://www.figma.com/api/mcp/asset/41d97c29-d6c8-4fed-8ed1-c7e7daa2d717"
